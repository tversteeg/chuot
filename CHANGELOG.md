...
- Update rust crate [wgpu](https://crates.io/crates/wgpu) to v25 by @renovate[bot]
- Update rust crate [phf](https://crates.io/crates/phf) to 0.12.0 by @renovate[bot]
- Update rust crate [phf_codegen](https://crates.io/crates/phf_codegen) to 0.12.0 by @renovate[bot]
- Update rust crate [wgpu](https://crates.io/crates/wgpu) to v26 by @renovate[bot]
- Update rust crate [litrs](https://crates.io/crates/litrs) to 0.5.0 by @renovate[bot]
- Update rust crate [notify-debouncer-mini](https://crates.io/crates/notify-debouncer-mini) to 0.7.0 by @renovate[bot]
- Update rust crate [phf](https://crates.io/crates/phf) to 0.13.0 by @renovate[bot]
- Update rust crate [phf_codegen](https://crates.io/crates/phf_codegen) to 0.13.0 by @renovate[bot]
- Update rust crate [hashbrown](https://crates.io/crates/hashbrown) to 0.16.0 by @renovate[bot]
- Update rust crate [png](https://crates.io/crates/png) to 0.18.0 by @renovate[bot]
- Update rust crate [wgpu](https://crates.io/crates/wgpu) to v27 by @renovate[bot]
...
- Update stefanzweifel/git-auto-commit-action action to v6 by @renovate[bot]
- Update rust crate [naga](https://crates.io/crates/naga) to v26 by @renovate[bot]
- Update actions/checkout action to v5 by @renovate[bot]
- Update rust crate [naga](https://crates.io/crates/naga) to v27 by @renovate[bot]
