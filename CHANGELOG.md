...
- [**breaking**] Use dynamic typestate builder to improve performance and allow extensions
- [**breaking**] Implement typestate without using traits that need to be loaded
- [**breaking**] Make better use of generics to reduce code duplication

#### Graphics

- [**breaking**] Use rgb crate for all colors, exposed as `chuot::RGBA8`

#### Path

- [**breaking**] Change re-export path of `chuot::context::{Axis,Button,MouseButton,KeyCode}` to `chuot::{GamepadAxis,GamepadButton,MouseButton,KeyCode}`
...
- [**breaking**] Add a main game and a UI camera system
- Add `CameraContext::set_lerp{_x,_y}`
- Implement screen shake with `CameraContext::shake`
- Add `{Sprite,Text}Context::translate_previous{,_x,_y}` for smooth camera movement of moving objects

#### Entrypoint

- Add optional `Game::init` which is called once after the window has been created
...
- Update rust crate [wgpu](https://crates.io/crates/wgpu) to v22
- Update rust crate [glam](https://crates.io/crates/glam) to 0.29.0
- Update rust crate [smol_str](https://crates.io/crates/smol_str) to 0.3.0
- Update rust crate [gilrs](https://crates.io/crates/gilrs) to 0.11.0
- Update rust crate [bytemuck](https://crates.io/crates/bytemuck), rust crate [fastrand](https://crates.io/crates/fastrand), rust crate [kira](https://crates.io/crates/kira), rust crate [rgb](https://crates.io/crates/rgb), rust crate [smol_str](https://crates.io/crates/smol_str), rust crate [winit](https://crates.io/crates/winit), rust crate [wgpu](https://crates.io/crates/wgpu), rust crate [wasm-bindgen-futures](https://crates.io/crates/wasm-bindgen-futures), rust crate [web-sys](https://crates.io/crates/web-sys), rust crate [naga](https://crates.io/crates/naga), rust crate [quote](https://crates.io/crates/quote) & rust crate [sprite_dicing](https://crates.io/crates/sprite_dicing)
- Update rust crate [hashbrown](https://crates.io/crates/hashbrown) to 0.15.0

#### Graphics

- Always render with viewport to fix flipping issue

#### Input

- Handle button press and release within a single update tick
...
- Add falling-sand example
- Add random colors and better updates to falling-sand examples
...
- Create CREDITS.md of inspiration and sources

#### Deps

- Update rust crate [naga](https://crates.io/crates/naga) to v22
...
- Update rust crate [wgsl-minifier](https://crates.io/crates/wgsl-minifier) to 0.6.0

#### Release

- Don't tag `chuot-macros` and remove `chuot-` prefix from future tags
